                ...
                columns: [
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            align: "center",
                            formatter: function (value, row, index) {
                                return '<a href="#" onclick="preview(\'a11\',\''+row.khdx+ '\')">' + row.a11 + '</a>';
                            }
                        },
                        {
                            field: 'a12',
                            ...
                            align: "center",
                            formatter: function (value, row, index) {
                                return '<a href="#" onclick="preview(\'a12\',\''+row.khdx+ '\')">' + row.a12 + '</a>';
                            }
                        },
                        {
                            field: 'a13',
                            ...
                            align: "center",
                            formatter: function (value, row, index) {
                                return '<a href="#" onclick="preview(\'a13\',\''+row.khdx+ '\')">' + row.a13 + '</a>';
                            }
                        },
                        {
                            field: 'a14',
                            ...
                            align: "center",
                            formatter: function (value, row, index) {
                                return '<a href="#" onclick="preview(\'a14\',\''+row.khdx+ '\')">' + row.a14 + '</a>';
                            }
                        },
